...
-- ============================================================
-- 7.1 alert_threshold_settings: admin-configured alert thresholds
-- ============================================================
...
CREATE TRIGGER trg_alert_threshold_settings_updated BEFORE UPDATE ON alert_threshold_settings FOR EACH ROW EXECUTE FUNCTION update_updated_at();
